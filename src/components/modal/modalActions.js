...
export const submitRegistrationForm = () => {
  return (dispatch, getState) => {
    ...
    return axios.post('https://oinkster.herokuapp.com/send/confirmationmail', user) //make sure the url is connected to the server droplet
      .then(res => {
        toastr.success('success', `Welcome ${user.firstName}`)
        axios.post('https://oinkster.herokuapp.com/send/userdata', user)
        dispatch(closeModal())
